...
//                        }
    ...
    public void handleMedia(String type){
        ...
        if (type.equals("image")) {
            ...
            imgRef.getFile(localFile).addOnCompleteListener(DemoFirebaseActivity.this, new OnCompleteListener<FileDownloadTask.TaskSnapshot>() {
                @Override
...
//                });
    ...
    public void showErrorDialog(){
        AlertDialog.Builder builder = new AlertDialog.Builder(DemoFirebaseActivity.this);
